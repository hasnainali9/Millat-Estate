...
@section('content')
{{ Form::open(['route' => ['admin.page.update', $page->slug], 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'page']) }}
    @csrf
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="card-box text-right d-none d-sm-none d-md-block">
                    {{ Form::submit('Update Page', ['class' => 'btn btn-primary btn-block']) }}
                </div>
                <div class="card-box">
                    <div class="form-group">
                        {{ Form::label('image', 'Image', ['class' => 'col-form-label']) }}
                        {{ Form::file('image', ['class' => 'dropify', 'data-max-file-size' => '2M', 'data-default-file' => asset($page->image)]) }}
                    </div>
                </div>
                <div class="card-box">
                    <div class="custom-control custom-switch">
                        {{ Form::checkbox('is_active', true, $page->is_active, ['class' => 'custom-control-input', 'id' => 'is_active']) }}
